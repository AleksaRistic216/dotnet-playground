...
- `articles/controls-and-libraries/scheduler/styles-and-templates.md` (`xref:119866`)
- `articles/controls-and-libraries/scheduler/styles-and-templates/visual-appointment.md` (`xref:119867`)
- `articles/controls-and-libraries/scheduler/styles-and-templates/scheduler-elements-that-support-templates.md` (`xref:400598`)
- `articles/controls-and-libraries/scheduler/appearance-customization.md` (`xref:400994`)
