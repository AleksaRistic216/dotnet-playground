...
- `articles/mvvm-framework/viewmodels/passing-data-between-viewmodels-isupportparameter.md` (`xref:17448`)
- `articles/mvvm-framework/viewmodels/viewmodel-relationships-isupportparentviewmodel.md` (`xref:17449`)
- `articles/mvvm-framework/messenger.md` (`xref:17474`)
- `articles/mvvm-framework/services.md` (`xref:17414`) — for `ServiceSearchMode.PreferParents`
