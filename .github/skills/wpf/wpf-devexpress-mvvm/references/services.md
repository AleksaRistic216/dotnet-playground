...
See `articles/mvvm-framework/services/create-a-custom-service.md` (`xref:16920`) for the full pattern.
...
- `articles/mvvm-framework/services.md` (`xref:17414`)
- `articles/mvvm-framework/services/getting-started.md` (`xref:17444`)
- `articles/mvvm-framework/services/predefined-set.md` (`xref:113931`)
- `articles/mvvm-framework/services/services-in-viewmodelbase-descendants.md` (`xref:17446`)
- `articles/mvvm-framework/services/services-in-generated-view-models.md` (`xref:17447`)
- `articles/mvvm-framework/services/services-in-custom-viewmodels.md` (`xref:17450`)
- `articles/mvvm-framework/services/create-a-custom-service.md` (`xref:16920`)
- `articles/mvvm-framework/services/predefined-set/dxmessageboxservice.md` (`xref:17415`)
