...
- `articles/controls-and-libraries/pivot-grid/conditional-formatting.md` (`xref:114038`)
- `articles/controls-and-libraries/pivot-grid/end-user-capabilities/applying-conditional-formatting.md` (`xref:114395`)
- `articles/controls-and-libraries/pivot-grid/examples/appearance/how-to-apply-conditional-formatting-to-data-cells.md` (`xref:8035`)
