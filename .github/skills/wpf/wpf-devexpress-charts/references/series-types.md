...
- `articles/controls-and-libraries/charts-suite/chart-control/series/2d-series-types.md` (`xref:114223`)
- `articles/controls-and-libraries/charts-suite/chart-control/series/series-type-compatibility.md`
- `articles/controls-and-libraries/charts-suite/chart-control/series/series.md` (`xref:6339`)
