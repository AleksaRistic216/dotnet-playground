...
- `articles/controls-and-libraries/charts-suite/chart-control/provide-data/provide-data.md` (`xref:6854`)
- `articles/controls-and-libraries/charts-suite/chart-control/provide-data/bind-a-series-to-a-data-source.md` (`xref:7921`)
- `articles/controls-and-libraries/charts-suite/chart-control/provide-data/create-a-series-manually.md` (`xref:7919`)
- `articles/controls-and-libraries/charts-suite/chart-control/provide-data/add-points-to-a-series-manually.md` (`xref:7920`)
- `articles/controls-and-libraries/charts-suite/chart-control/provide-data/define-a-template-for-automatic-series.md` (`xref:7922`)
- `articles/controls-and-libraries/charts-suite/chart-control/provide-data/series-scale-types.md` (`xref:8453`)
