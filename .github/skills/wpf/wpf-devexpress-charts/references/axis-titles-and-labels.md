...
- `articles/controls-and-libraries/charts-suite/chart-control/axes/axis-titles.md` (`xref:7096`)
- `articles/controls-and-libraries/charts-suite/chart-control/axes/axis-labels.md` (`xref:6336`)
