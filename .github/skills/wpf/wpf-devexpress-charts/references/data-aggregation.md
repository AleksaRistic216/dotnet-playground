...
**Aggregation is the default choice for most apps.** Summaries are advanced (see `articles/.../calculate-summaries.md` `xref:400970`).
...
- `articles/controls-and-libraries/charts-suite/chart-control/data-aggregation.md` (`xref:16846`)
- `articles/controls-and-libraries/charts-suite/chart-control/calculate-summaries.md` (`xref:400970`)
- `articles/controls-and-libraries/charts-suite/chart-control/histogram.md` (`xref:400974`)
