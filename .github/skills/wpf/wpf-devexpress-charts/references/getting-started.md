...
- `articles/controls-and-libraries/charts-suite/chart-control/getting-started/getting-started.md` (`xref:5854`)
- `articles/controls-and-libraries/charts-suite/chart-control/getting-started/lesson-1-bind-chart-series-to-data.md` (`xref:9757`)
