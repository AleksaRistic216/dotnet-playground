...
- `articles/controls-and-libraries/data-editors.md` § Simple Controls (`xref:6190#simple-controls`)
- `articles/controls-and-libraries/data-editors/included-components.md` § Buttons (`xref:6933`)
