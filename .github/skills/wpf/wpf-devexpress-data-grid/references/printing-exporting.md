...
| Generate a customizable report (designer-editable, parameters, formulas) | **Report Generation** | `xref:117300` (separate API) |
...
See `articles/controls-and-libraries/data-grid/printing-and-exporting/grid-based-report-generation.md` and `xref:117300`.
