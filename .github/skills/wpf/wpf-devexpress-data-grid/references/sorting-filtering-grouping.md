...
Field names in square brackets. Operators: `=`, `<>`, `<`, `>`, `<=`, `>=`, `Like`, `In`, `Between`, `IsNull`, `Contains`, `StartsWith`, `EndsWith`, `Not`, `And`, `Or`. Date literals in `#...#`. See `xref:4928` (Criteria Language Syntax) and `xref:6499` (Filter Expressions).
