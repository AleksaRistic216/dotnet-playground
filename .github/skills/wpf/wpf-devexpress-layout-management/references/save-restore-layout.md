...
- `articles/controls-and-libraries/layout-management/dock-windows/saving-and-restoring-the-layout-of-dock-panels-and-controls.md` (`xref:7059`)
- `articles/controls-and-libraries/layout-management/tile-and-layout/common-features/save-and-restore-item-layout.md` (`xref:8155`)
- `articles/common-concepts/save-and-restore-layouts.md` (`xref:7391`)
- `articles/common-concepts/save-and-restore-layouts/dxserializer-events.md` (`xref:7410`)
