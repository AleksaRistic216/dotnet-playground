...
> For the full list, see `xref:16863` in DevExpress docs.
...
- `articles/controls-and-libraries/layout-management/tile-and-layout/layout-and-data-layout-controls/layout-control.md` (`xref:8147`)
- `articles/controls-and-libraries/layout-management/tile-and-layout/layout-and-data-layout-controls/data-layout-control.md` (`xref:11540`)
- `articles/controls-and-libraries/layout-management/tile-and-layout/layout-and-data-layout-controls/layout-items-and-groups.md` (`xref:8150`)
- `articles/controls-and-libraries/layout-management/tile-and-layout/tile-layout-control.md` (`xref:11541`)
- `articles/controls-and-libraries/layout-management/tile-and-layout/flow-layout-control.md` (`xref:8148`)
- `articles/controls-and-libraries/layout-management/tile-and-layout/dock-layout-control.md` (`xref:8149`)
- `articles/controls-and-libraries/layout-management/dock-windows.md` (`xref:6191`)
