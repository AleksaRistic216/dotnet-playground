...
- **Tool Calling** (`AIToolsBehavior`) — let the AI invoke methods on your view models (`xref:CoreLibraries/405585`).
- **Chat with Your Own Data** (RAG via OpenAI Assistant API) — `xref:405606`.
- **Manage Multiple Chat Clients** — keyed services and runtime switching (`xref:405607`).
- **Chat Resources** — supply text/binary context the AI can attach to requests (`xref:405613`).
- **AI-powered Extensions** on other DevExpress controls (Smart Paste, Smart Search, Smart Autocomplete, AI Assistant in `TextEdit` / Rich Text / Spreadsheet) — `xref:405224`.
...
- `articles/ai-powered-extensions/ai-chat-control.md` (`xref:405434`)
- `articles/ai-powered-extensions.md` (`xref:405223`)
- `articles/ai-powered-extensions/ai-chat-control/chat-with-your-own-data.md` (`xref:405606`)
- `articles/ai-powered-extensions/ai-chat-control/manage-multiple-chat-clients.md` (`xref:405607`)
- `articles/dotnet-core-support/project-template-kit.md` (`xref:405220`)
