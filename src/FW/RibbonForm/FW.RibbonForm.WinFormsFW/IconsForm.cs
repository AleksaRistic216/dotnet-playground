    ...
    public partial class IconsForm : DevExpress.XtraBars.Ribbon.RibbonForm {
        ...
        void BuildUI() {
            ...
            toggleBtn.Click += (s, e) => {
                ...
                Text = "Icons Test — " + WindowsFormsSettings.ActiveIconSet + " / " + IconSetSettings.IconStyle;
                RefreshAllIcons(ribbon);
            };
            layout.Controls.Add(toggleBtn);

            var styleBtn = new SimpleButton {
                Text = "Style: " + IconSetSettings.IconStyle + " → switch",
                Width = 250,
                Height = 40
            };
            styleBtn.Click += (s, e) => {
                IconSetSettings.IconStyle =
                    IconSetSettings.IconStyle == IconStyle.Regular ? IconStyle.Filled : IconStyle.Regular;
                styleBtn.Text = "Style: " + IconSetSettings.IconStyle + " → switch";
                Text = "Icons Test — " + WindowsFormsSettings.ActiveIconSet + " / " + IconSetSettings.IconStyle;
                RefreshAllIcons(ribbon);
            };
            ...
            var colorBtn = new SimpleButton {
                Text = "Color: " + IconSetSettings.IconColor + " → switch",
                Width = 320,
                Height = 40
            };
            colorBtn.Click += (s, e) => {
                IconSetSettings.IconColor =
                    IconSetSettings.IconColor == IconColor.Monochrome ? IconColor.Multicolor : IconColor.Monochrome;
                colorBtn.Text = "Color: " + IconSetSettings.IconColor + " → switch";
                RefreshAllIcons(ribbon);
            };
