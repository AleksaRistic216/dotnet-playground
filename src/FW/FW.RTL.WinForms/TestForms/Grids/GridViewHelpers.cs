...
namespace FW.RTL.WinForms.TestForms.Grids {
    internal static class GridViewHelpers {
        ...
        private static void CreateLayout_PersonalInfo_WorkInfo_Address(AdvBandedGridView view) {
            ...
            var colId = CreateColumn(view, "Id", "ID", bandPersonal, 0, 2);
        ...
        private static void CreateLayout_ThreeRowMixed(AdvBandedGridView view) {
            ...
            CreateColumn(view, "Id", "ID", bandMain, 0, 3).Width = 50;
            ...
            CreateColumn(view, "Rating", "Rating", bandMain, 0, 3).Width = 50;
            ...
            CreateColumn(view, "Street", "Street", bandContactLoc, 1, 2).Width = 120;
            ...
            CreateColumn(view, "Company", "Company", bandEmployment, 0, 2).Width = 150;
            ...
            CreateColumn(view, "IsActive", "Active", bandEmployment, 0, 3).Width = 50;
